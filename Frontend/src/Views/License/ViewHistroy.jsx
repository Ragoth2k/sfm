...
const History = () => {
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        console.log("Fetching history for License ID:", id); // Debug log
    ...
    if (id) { // Ensure licenseId is defined before making the request
      fetchHistory();
    } else {
                              ...
                              <div className="row justify-content-center">
                                <div className="col-md-9">
                                  <div className="p-3 rounded">
                                    <h3 className="text-secondary text-center">View License History</h3>
                                    {loading ? (
                                      <p>Loading...</p>
                                    ) : (
