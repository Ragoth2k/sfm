                              ...
                              <div className="row justify-content-center">
                                <div className="col-md-9">
                                  <div className="p-3 rounded">
                                    <h3 className="text-secondary text-center">Update License Status</h3>
                                    <form className="row g-3" onSubmit={handleSubmit}>
                                      <div className="col-12">
                                        <label htmlFor="update_status" className="form-label search-label">
                                          Status:
                                        </label>
                                        <select
                                      ...
                                      <div className="col-12">
                                        <label htmlFor="remarks" className="form-label search-label">
                                          Remarks:
                                        </label>
                                        <input
                                          type="text"
