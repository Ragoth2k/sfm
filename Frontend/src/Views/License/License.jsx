...
const Licenses = () => {
  ...
  const handleDelete = async (id) => {
    try {
      const result = await axiosInstance.delete('/license/delete_license/' + id);
      if (result.data.Status) {
  ...
  const handleSearchChange = (event) => {
    ...
    const filteredLicenses = licenses.filter((e) =>
                        ...
                        <div className="card-body">
                          <div className="box-header with-border">
                            <div className="box_add">
                              <button>
                                <Link to="/display/add_license">Add License</Link>
                              </button>
                            </div>
                                  ...
                                  {loading ? (
                                    ...
                                    filterLicenses.map((item, index) => (
                                      <tr key={item.id}>
                                        ...
                                        <td>{item.renewal_date ? new Date(item.renewal_date).toLocaleDateString('en-GB') : ""}</td>
                                        <td>
                                          <Link
                                            onClick={() => {
