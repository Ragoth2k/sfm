                                ...
                                <div className="col-md-9">
                                  <div className="p-3 rounded">
                                    ...
                                    <form className="row g-3" onSubmit={handleSubmit}>
                                      ...
                                      <div className="col-12">
                                        <label htmlFor="linked_to" className="form-label search-label">
                                          Linked To:
                                        </label>
                                        <input
                                          type="text"
                                      ...
                                      <div className="col-12 form-check form-switch">
                                        <label className="form-check-label search-label" htmlFor="flexSwitchCheckDefault">
                                          Enable Renewal Reminder <span className="text-secondary">(optional)</span>
                                        </label>
                                        <input
