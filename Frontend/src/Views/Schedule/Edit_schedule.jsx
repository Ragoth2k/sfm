...
const Edit_Schedule = () => {
  ...
  useEffect(() => {
    axiosInstance.get(`/schedule/get_schedule/${id}`)
      .then(result => {
        ...
        setSchedule({
          ...
          dateStart: fetchedSchedule.dateStart ? dayjs(fetchedSchedule.dateStart).format('YYYY-MM-DD') : '',
          dateEnd: fetchedSchedule.dateEnd ? dayjs(fetchedSchedule.dateEnd).format('YYYY-MM-DD') : '',
  ...
  const handleSubmit = (e) => {
    ...
    // Update schedule
    axiosInstance.put(`/schedule/edit_schedule/${id}`, schedule)
      .then(result => {
                              ...
                              <div className="row justify-content-center">
                                <div className="col-md-9">
                                  <div className="p-3 rounded">
                                    <h3 className="text-secondary text-center">Edit Schedule</h3>
                                    <form onSubmit={handleSubmit} className="row g-3">
                                      ...
                                      <div className="form-group">
                                        ...
                                        <input
                                          ...
                                          className="form-control"
                                          value={schedule.team}
                                          onChange={(e) => setSchedule({ ...schedule, team: e.target.value })}
                                        />
                                      </div>                                     
                                       <div className="form-group">
                                          <label
                                          ...
                                          <select  
                                            ...
                                            required>
                                            <option disabled value="">Select Type of Maintenance</option>
                                      ...
                                      <div className="form-group">
                                        ...
                                        <input
                                          ...
                                          onChange={(e) => setSchedule({ ...schedule, priority: e.target.value })}
                                        />
                                      </div>
                                      {/* <div className="form-group">
                                      ...
                                      <div className="form-group">
                                        <label htmlFor="reschedulestart" className="form-label">ReSchedule StartDate (optional)</label>
                                        <input
                                          type="date"
                                          id="reschedulestart"
                                          name="reschedulestart"
                                          className="form-control"
                                          value={schedule.reschedulestart ? dayjs(schedule.reschedulestart).format('YYYY-MM-DD') : ''}
                                          onChange={(e) => setSchedule({ ...schedule, reschedulestart: e.target.value })}
                                        />
                                      </div>
                                      <div className="form-group">
                                        <label htmlFor="rescheduleend" className="form-label">ReSchedule EndDate (optional)</label>
                                        <input
                                          type="date"
                                          id="rescheduleend"
                                          name="rescheduleend"
                                          className="form-control"
                                          value={schedule.rescheduleend ? dayjs(schedule.rescheduleend).format('YYYY-MM-DD') : ''}
                                          onChange={(e) => setSchedule({ ...schedule, rescheduleend: e.target.value })}
                                        />
                                      </div>
                                      <div className="form-group">
                                        ...
                                        <textarea
                                          ...
                                          onChange={(e) => setSchedule({ ...schedule, remarks: e.target.value })}
                                        />
                                      </div>
