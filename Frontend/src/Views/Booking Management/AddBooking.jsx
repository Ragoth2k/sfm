...
const AddBooking = () => {
    ...
    useEffect(() => {
        if (booking.zone) {
            axiosInstance.post("/booking/get_schools_by_zone", { zone: booking.zone })
                .then((result) => {
    ...
    useEffect(() => {
        if (booking.schoolName) {
            ...
            if (selectedSchool) {
                axiosInstance.post("/booking/get_blocks_by_school", { schoolId: selectedSchool.id })
                    .then((result) => {
    ...
    useEffect(() => {
        if (booking.schoolName && booking.block) {
            const selectedSchool = schools.find(school => school.school_name === booking.schoolName);
            if (selectedSchool) {
                axiosInstance.post("/booking/get_levels_by_school_and_block", {
    ...
    useEffect(() => {
        if (booking.schoolName && booking.block && booking.level) {
            const selectedSchool = schools.find(school => school.school_name === booking.schoolName);
            if (selectedSchool) {
                axiosInstance.post("/booking/get_rooms_by_school_block_level", {
                    schoolId: selectedSchool.id,
                    block: booking.block,
                    level: booking.level
                })
    ...
    useEffect(() => {
        if (booking.roomNo) {
            axiosInstance.post("/booking/get_room_details", { roomNo: booking.roomNo })
                .then((result) => {
