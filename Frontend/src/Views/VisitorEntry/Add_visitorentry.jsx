...
//   // Fetch visitor details by code
//   const handleFetchVisitor = () => {
//     axiosInstance
//       .post('/entry/get_visitor_by_code', { visitor_code: visitor.visitor_code })
//       .then(result => {
...
//             check_in: fetchedVisitor.check_in || dayjs(fetchedVisitor.check_in).format('YYYY-MM-DD HH:mm:ss'),
//           }));
//         } else {
...
//                         <div className="mb-3">
//                           <label htmlFor="visitor_code" className="form-label">Visitor Code:</label>
//                           <input
//                             type="text"
...
//                         <button type="button" className="btn btn-info mb-3" onClick={handleFetchVisitor}>
//                           Fetch Visitor
//                         </button>

//                         <div className="mb-3">
//                           <label htmlFor="visitor_name" className="form-label">Visitor Name:</label>
//                           <input
//                             type="text"
//                             className="form-control"
//                             id="visitor_name"
...
//                         <div className="mb-3">
//                           <label htmlFor="expected_arrival_time" className="form-label">Expected Arrival Time:</label>
//                           <input
//                             type="datetime-local"
//                             className="form-control"
...
//                         <div className="mb-3">
//                           <label htmlFor="from_organization" className="form-label">From:</label>
//                           <input
//                             type="text"
//                             className="form-control"
...
//                           <button className="btn btn-danger" type="button" onClick={() => navigate(-1)}>Back</button>
//                         </div>
//                       </form>
//                     </div>
//                   </div>
