                ...
                <li className='sidebar-contents-list-item'>
                  ...
                  {isDropdownOpen && (
                    <div className='sidebar-contents-list-item-master-content'>
                      <ul className='sidebar-contents-dropdown-list'sx={{overflow:'hidden'}}>
                        ...
                        <div className='sidebar-contents-master-dropdown-list-iaq'>
                          <span className='dropdown-item-iaq-text' onClick={() => { navigate('/display/license'); }}>License</span>
                        </div>

                        <div className='sidebar-contents-master-dropdown-list-iaq'>
                          <span className='dropdown-item-iaq-text' onClick={() => { navigate('/display/visitor'); }}>Visitor Invite</span>
                        </div>

                        <div className='sidebar-contents-master-dropdown-list-iaq'>
                          <span className='dropdown-item-iaq-text' onClick={() => { navigate('/display/visitor_entry'); }}>Visitor Entry</span>
                        </div>
                        
                        <div className='sidebar-contents-master-dropdown-list-iaq'>
                          <span className='dropdown-item-iaq-text' onClick={() => { navigate('/display/schedule'); }}>Schedule Maintenance</span>
                        </div>
