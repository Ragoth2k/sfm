...
import Layout from "../../../../molecules/Layout/Layout.js";
import { useLocation, useNavigate } from "react-router-dom";
import Table from "../../../../molecules/Table/Table.js";
import BorderColorOutlinedIcon from "@mui/icons-material/BorderColorOutlined";
import DeleteOutlineSharpIcon from "@mui/icons-material/DeleteOutlineSharp";
import Tooltip from "../../../../atoms/Tooltip/Tooltip.js";
import ErrorOutlineOutlinedIcon from "@mui/icons-material/ErrorOutlineOutlined";
import DeleteFlowStep from "../../../Delete/PTW_module/DeleteFlow/DeleteFlowStep.js";
...
import NewFlowStep from "../../../Create/PTW_module/ApprovalFlow/NewFlowStep.js";
...
const UpdateFlow = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (await validate()) {
      ...
      try {
        await axiosInstance.put(`/flow/updateFlowName/${flowId}`, formData);
        handleClear();
        saveFlowName();
      } catch (error) {
