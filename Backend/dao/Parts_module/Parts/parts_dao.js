...
export default class PartsDao {
    ...
    static async updatePartsDao(partsData, partId) {
        ...
        try {
            const partsDataArray = [
                partsData.partname, partsData.partsType, partsData.quantity, partsData.unitOfMeasure,
                partsData.linkToAssetId, partsData.locationZone, partsData.locationSchoolId,
                partsData.locationSchoolName, partsData.locationBlock, partsData.locationLevel,
                partsData.locationRoomNo, partsData.locationRoomName, partsData.locQRID,
                partsData.partsImage, partsData.storeName, partsData.updateBy, partId];
